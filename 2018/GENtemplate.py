...
# with command line options: ADDGravToLL_LambdaT-4000_M-2000ToInf_13TeV-pythia8_cff.py --python_filename step1_GEN-SIM.py --mc --eventcontent RAWSIM --conditions 102X_upgrade2018_realistic_v9 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --nThreads 1 --geometry DB:Extended --era Run2_2018 --fileout file:step1.root --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('ADDGravToLL_LambdaT-%d_M-%dTo%s_13TeV-pythia8_cff.py nevts:1'),
