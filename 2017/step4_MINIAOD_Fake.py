...
# with command line options: step4 --python_filename step4_MINIAOD.py --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v14 --step PAT --nThreads 1 --era Run2_2017,run2_miniAOD_94XFall17 --filein file:step3.root --fileout file:step4.root --no_exec
