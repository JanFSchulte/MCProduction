...
# with command line options: Configuration/Generator/python/ADDGravToLL_LambdaT-4000_M-2000ToInf_13TeV-pythia8_cff.py --python_filename step1_GEN-SIM.py --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --nThreads 1 --geometry DB:Extended --era Run2_2017 --fileout file:step0.root --no_exec
...
process.source = cms.Source("EmptySource",
			    ...
			    numberEventsInLuminosityBlock = cms.untracked.uint32(300)
			    )
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/ADDGravToLL_LambdaT-%d_M-%dTo%s_13TeV-pythia8_cff.py nevts:1'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    PythiaParameters = cms.PSet(
        parameterSets = cms.vstring('pythia8CommonSettings', 
            'pythia8CP5Settings', 
            'processParameters'),
        processParameters = cms.vstring('ExtraDimensionsLED:LambdaT = %d', 
            ...
            'PhaseSpace:mHatMin = %d', 
            'PhaseSpace:mHatMax = %d'),
